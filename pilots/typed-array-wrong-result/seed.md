...
```
runtime/buffer-typed-array :: E3/intrinsic-object:ecma-262 :: value-semantics/wrong-result :: assertion/expected-mismatch
```

This coordinate ranks **#8** in the full-suite Pin-Art matrix
(`pilots/test262-categorize/full-suite/results/test262-full-2026-05-25-165734-p2/matrix.md`),
**614 fails** in the canonical full-suite run. Per the apparatus
...
**Heuristics §IV classification**: D (Runtime Intrinsic Semantics) — typed-array correctness

TypedArray/DataView/ArrayBuffer methods produce wrong values. Family-wide across all TypedArray ctors. Likely concentrated at ValidateTypedArray / IntegerIndexedElementGet / SetValueInBuffer abstract ops.

## Apparatus

- **Exemplar suite**: `exemplars/exemplars.txt` — 100 paths stratified-
  sampled from the 614-fixture pool by surface family (proportional +
...
- large enough to matter — confirmed by pool size (614 fails)
