...
pub fn build_char_at() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.1".into(),
        rust_name: "string_prototype_char_at".into(),
        title: "String.prototype.charAt ( pos )".into(),
        body,
    }
}
...
pub fn build_char_code_at() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.2".into(),
        rust_name: "string_prototype_char_code_at".into(),
        title: "String.prototype.charCodeAt ( pos )".into(),
        body,
    }
}
...
pub fn build_concat() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.3".into(),
        rust_name: "string_prototype_concat".into(),
        title: "String.prototype.concat ( ...args )".into(),
        body,
    }
}
...
pub fn build_to_lower_case() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.28".into(),
        rust_name: "string_prototype_to_lower_case".into(),
        title: "String.prototype.toLowerCase ( )".into(),
        body,
    }
}
...
pub fn build_to_upper_case() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.30".into(),
        rust_name: "string_prototype_to_upper_case".into(),
        title: "String.prototype.toUpperCase ( )".into(),
        body,
    }
}
...
pub fn build_to_locale_lower_case() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.26".into(),
        rust_name: "string_prototype_to_locale_lower_case".into(),
        title: "String.prototype.toLocaleLowerCase ( [ reserved1 [ , reserved2 ] ] )".into(),
        body,
    }
}
...
pub fn build_to_locale_upper_case() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.27".into(),
        rust_name: "string_prototype_to_locale_upper_case".into(),
        title: "String.prototype.toLocaleUpperCase ( [ reserved1 [ , reserved2 ] ] )".into(),
        body,
    }
}
...
pub fn spec_steps_to_locale_lower_case() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_to_lower_case_via"],
        throws: None,
...
pub fn spec_steps_to_locale_upper_case() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_to_upper_case_via"],
        throws: None,
...
pub fn build_trim() -> IRFunction {
    trim_section(
        "22.1.3.32",
        "string_prototype_trim",
        "String.prototype.trim ( )",
        "string_proto_trim_via",
    )
}
pub fn build_trim_start() -> IRFunction {
    trim_section(
        "22.1.3.34",
        "string_prototype_trim_start",
        "String.prototype.trimStart ( )",
        "string_proto_trim_start_via",
    )
}
pub fn build_trim_end() -> IRFunction {
    trim_section(
        "22.1.3.33",
        "string_prototype_trim_end",
        "String.prototype.trimEnd ( )",
        "string_proto_trim_end_via",
    )
}
// trimLeft / trimRight are Annex B legacy aliases.
pub fn build_trim_left() -> IRFunction {
    trim_section(
        "B.2.2.1",
        "string_prototype_trim_left",
        "String.prototype.trimLeft ( )",
        "string_proto_trim_start_via",
    )
}
pub fn build_trim_right() -> IRFunction {
    trim_section(
        "B.2.2.2",
        "string_prototype_trim_right",
...
pub fn spec_steps_trim_start() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_trim_start_via"],
        throws: None,
...
pub fn spec_steps_trim_end() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_trim_end_via"],
        throws: None,
...
pub fn build_repeat() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.21".into(),
        rust_name: "string_prototype_repeat".into(),
        title: "String.prototype.repeat ( count )".into(),
        body,
    }
}
...
pub fn build_pad_start() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.17".into(),
        rust_name: "string_prototype_pad_start".into(),
        title: "String.prototype.padStart ( maxLength [ , fillString ] )".into(),
        body,
    }
}
...
pub fn build_pad_end() -> IRFunction {
    ...
    IRFunction {
        spec_section: "22.1.3.16".into(),
        rust_name: "string_prototype_pad_end".into(),
        title: "String.prototype.padEnd ( maxLength [ , fillString ] )".into(),
        body,
    }
}
...
pub fn build_split() -> IRFunction {
    two_arg_section(
        "22.1.3.23",
        "string_prototype_split",
        "String.prototype.split ( separator, limit )",
        "string_proto_split_via",
        "separator",
        "limit",
    )
}
pub fn build_replace() -> IRFunction {
    two_arg_section(
        "22.1.3.15",
        "string_prototype_replace",
        "String.prototype.replace ( searchValue, replaceValue )",
        "string_proto_replace_via",
        "search",
        "replacement",
    )
}
pub fn build_replace_all() -> IRFunction {
    two_arg_section(
        "22.1.3.16",
        "string_prototype_replace_all",
        "String.prototype.replaceAll ( searchValue, replaceValue )",
        "string_proto_replace_all_via",
        "search",
        "replacement",
    )
}

pub fn spec_steps_split() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["string_proto_split_via"],       throws: None, prose: "Dispatch to separator[@@split] if present; else split S by separator with optional limit." }]
}
pub fn spec_steps_replace() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_replace_via"],
        throws: None,
        prose: "Dispatch to searchValue[@@replace] if present; else replace first occurrence in S.",
    }]
}
pub fn spec_steps_replace_all() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_replace_all_via"],
        throws: None,
        prose: "Dispatch to searchValue[@@replace] if present; else replace all occurrences in S.",
    }]
}

pub fn build_code_point_at() -> IRFunction {
    one_arg_section(
        "22.1.3.4",
        "string_prototype_code_point_at",
        "String.prototype.codePointAt ( pos )",
        "string_proto_code_point_at_via",
        "pos",
    )
}
...
pub fn build_normalize() -> IRFunction {
    zero_arg_section(
        "22.1.3.13",
        "string_prototype_normalize",
        "String.prototype.normalize ( [ form ] )",
        "string_proto_normalize_via",
    )
}
pub fn build_locale_compare() -> IRFunction {
    one_arg_section(
        "22.1.3.10",
        "string_prototype_locale_compare",
        "String.prototype.localeCompare ( that )",
        "string_proto_locale_compare_via",
        "that",
    )
}

pub fn spec_steps_code_point_at() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_code_point_at_via"],
        throws: None,
        prose: "Return the code point at the given UTF-16 index, or undefined if out of range.",
    }]
}
pub fn spec_steps_at() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_at_via"],
        throws: None,
        prose:
            "Return the character at the relative index (negative counts from end), or undefined.",
    }]
}
pub fn spec_steps_normalize() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_normalize_via"],
        throws: None,
        prose: "Return ? ToString(? RequireObjectCoercible(this)).",
    }]
}
pub fn spec_steps_locale_compare() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_locale_compare_via"],
        throws: None,
        prose: "Return -1/0/1 comparing this and that as strings.",
    }]
}
...
pub fn build_slice() -> IRFunction {
    two_arg_section(
        ...
        "string_proto_slice_via",
        "start",
        "end",
    )
}
pub fn build_substring() -> IRFunction {
    two_arg_section(
        "22.1.3.24",
        "string_prototype_substring",
        "String.prototype.substring ( start, end )",
        "string_proto_substring_via",
        "start",
        "end",
    )
}
pub fn build_substr() -> IRFunction {
    two_arg_section(
        "B.2.2.2",
        "string_prototype_substr",
        "String.prototype.substr ( start, length )",
        "string_proto_substr_via",
        "start",
        "length",
    )
}
pub fn build_index_of() -> IRFunction {
    two_arg_section(
        "22.1.3.8",
        "string_prototype_index_of",
        "String.prototype.indexOf ( searchString, position )",
        "string_proto_index_of_via",
        "search",
        "position",
    )
}
pub fn build_last_index_of() -> IRFunction {
    two_arg_section(
        ...
        "string_proto_last_index_of_via",
        "search",
        "position",
    )
}
pub fn build_includes() -> IRFunction {
    two_arg_section(
        ...
        "string_proto_includes_via",
        "search",
        "position",
    )
}
pub fn build_starts_with() -> IRFunction {
    two_arg_section(
        "22.1.3.23",
        "string_prototype_starts_with",
        "String.prototype.startsWith ( searchString, position )",
        "string_proto_starts_with_via",
        "search",
        "position",
    )
}
pub fn build_ends_with() -> IRFunction {
    two_arg_section(
        "22.1.3.6",
        "string_prototype_ends_with",
        "String.prototype.endsWith ( searchString, endPosition )",
        "string_proto_ends_with_via",
        "search",
        "position",
    )
}
...
pub fn spec_steps_slice() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_slice_via"],
        throws: None,
        prose: "Return the substring of S between clamped start and end indices.",
    }]
}
pub fn spec_steps_substring() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_substring_via"],
        throws: None,
        prose: "Return the substring of S between clamped, ordered start and end indices.",
    }]
}
pub fn spec_steps_substr() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_substr_via"],
        throws: None,
        prose: "Return a length-bounded substring of S starting at clamped start.",
    }]
}
pub fn spec_steps_index_of() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_index_of_via"],
        throws: None,
        prose: "Return the index of the first occurrence of searchString in S, or -1.",
    }]
}
pub fn spec_steps_last_index_of() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_last_index_of_via"],
        throws: None,
        prose: "Return the index of the last occurrence of searchString in S, or -1.",
    }]
}
pub fn spec_steps_includes() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_includes_via"],
        throws: None,
        prose: "Throw if searchString is a RegExp; otherwise return whether S contains it.",
    }]
}
pub fn spec_steps_starts_with() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_starts_with_via"],
        throws: None,
        prose: "Throw if searchString is a RegExp; otherwise return whether S starts with it.",
    }]
}
pub fn spec_steps_ends_with() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_ends_with_via"],
        throws: None,
        prose: "Throw if searchString is a RegExp; otherwise return whether S ends with it.",
    }]
}
...
pub fn spec_steps_pad_start() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_pad_start_via"],
        throws: None,
...
pub fn spec_steps_pad_end() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["string_proto_pad_end_via"],
        throws: None,
