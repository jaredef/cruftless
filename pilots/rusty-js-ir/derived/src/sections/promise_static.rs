...
pub fn build_all_resolve_element_factory() -> IRFunction {
    let body = vec![
        ...
        Step {
            spec_step: "param.remaining".into(),
            node: IRNode::Let {
                name: "remaining".into(),
                value: Expr::Arg(3),
            },
        ...
        Step {
            spec_step: "param.cap_resolve".into(),
            node: IRNode::Let {
                name: "cap_resolve".into(),
                value: Expr::Arg(4),
            },
        },
        Step {
            spec_step: "1".into(),
            node: IRNode::Return(Expr::Closure {
                label: "",
                params: vec!["x".into()],
                captures: vec![
                    "index".into(),
                ...
                body: vec![
                    ...
                    Step {
                        spec_step: "1".into(),
                        node: IRNode::If {
                            cond: Expr::Not(Box::new(Expr::ToBoolean(Box::new(
                                Expr::CallBuiltin {
...
pub fn spec_steps_all_resolve_element_factory() -> Vec<SpecStepRecord> {
    vec![
        SpecStepRecord {
            step_id: "1".into(),
            abstract_ops: vec!["cell_check_and_set_via"],
            throws: None,
            prose:
                "If alreadyCalled.[[Value]] is true, return undefined; otherwise set it to true.",
        },
        SpecStepRecord {
            step_id: "1.return".into(),
            abstract_ops: vec![],
            throws: None,
        ...
        SpecStepRecord {
            step_id: "8".into(),
            abstract_ops: vec!["cell_array_set_via"],
            throws: None,
            prose: "Set values[index] to x.",
        },
        SpecStepRecord {
            step_id: "9".into(),
            abstract_ops: vec!["promise_all_maybe_complete_via"],
            throws: None,
        ...
        Step {
            ...
            node: IRNode::Return(Expr::Closure {
                ...
                body: vec![
                    ...
                    Step {
                        spec_step: "8.entry".into(),
                        node: IRNode::Let {
                            name: "entry".into(),
                            value: Expr::CallBuiltin {
                                name: "make_settled_fulfilled_entry_via",
                                args: vec![v("x")],
                            },
                        },
                    },
                    Step {
                        spec_step: "9.store".into(),
                        node: IRNode::Expr(Expr::CallBuiltin {
                            name: "cell_array_set_via",
...
pub fn spec_steps_all_settled_resolve_element_factory() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord {
            step_id: "8.entry".into(),
            abstract_ops: vec!["make_settled_fulfilled_entry_via"],
            throws: None,
            prose: "Let entry be OrdinaryObjectCreate with status fulfilled and value x.",
        },
        SpecStepRecord {
            step_id: "9.store".into(),
            abstract_ops: vec!["cell_array_set_via"],
            throws: None,
                ...
                body: vec![
                    ...
                    Step {
                        ...
                        node: IRNode::Let {
                            name: "entry".into(),
                            value: Expr::CallBuiltin {
                                name: "make_settled_rejected_entry_via",
                                args: vec![v("x")],
                            },
                        },
                    },
...
pub fn spec_steps_all_settled_reject_element_factory() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord {
            step_id: "8.entry".into(),
            abstract_ops: vec!["make_settled_rejected_entry_via"],
            throws: None,
...
pub fn build_any_reject_element_factory() -> IRFunction {
    let body = vec![
        ...
        Step {
            spec_step: "param.cap_reject".into(),
            node: IRNode::Let {
                name: "cap_reject".into(),
                value: Expr::Arg(4),
            },
        },
        Step {
...
pub fn spec_steps_with_resolvers() -> Vec<SpecStepRecord> {
    vec![
        SpecStepRecord {
            step_id: "1".into(),
            abstract_ops: vec!["new_promise_value_via"],
            throws: None,
        ...
        SpecStepRecord {
            ...
            throws: None,
            prose:
                "Let resolveFn be a new built-in function whose internal slot captures the promise.",
        },
        SpecStepRecord {
            step_id: "2.a".into(),
            abstract_ops: vec!["promise_settle_fulfilled_via"],
            throws: None,
        ...
        SpecStepRecord {
            ...
            throws: None,
            prose:
                "Let rejectFn be a new built-in function whose internal slot captures the promise.",
        },
        SpecStepRecord {
            step_id: "3.a".into(),
            abstract_ops: vec!["promise_settle_rejected_via"],
            throws: None,
            prose: "When called with v, reject the captured promise with v.",
        },
        SpecStepRecord {
            step_id: "7".into(),
            abstract_ops: vec!["promise_with_resolvers_assemble_via"],
            throws: None,
...
pub fn build_finally() -> IRFunction {
    variadic_section(
        "27.2.5.3",
...
pub fn build_all_settled() -> IRFunction {
    variadic_section(
        "27.2.4.2",
        "promise_all_settled",
        "Promise.allSettled ( iterable )",
        "promise_all_settled_via",
    )
}
pub fn build_any() -> IRFunction {
    variadic_section(
        "27.2.4.3",
        "promise_any",
...
pub fn spec_steps_then() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["promise_then_via"],
        throws: None,
        prose: "Chain on a source Promise; queue or enqueue reactions based on settlement state.",
    }]
}
pub fn spec_steps_catch() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["promise_catch_via"],
        throws: None,
        prose: "Chain rejected-only handler; equivalent to then(undefined, onRejected).",
    }]
}
pub fn spec_steps_finally() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["promise_finally_via"],
        throws: None,
        prose: "Run onFinally side-effect callback, then propagate source settlement to the chain.",
    }]
}
pub fn spec_steps_all() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["promise_all_via"],         throws: None, prose: "Aggregate iterable to a single Promise resolved with the array of values, or rejected with the first rejection (v1 sync-only)." }]
}
pub fn spec_steps_all_settled() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["promise_all_settled_via"],
        throws: None,
        prose: "Return a Promise resolved with {status, value/reason} entries per iteration item.",
    }]
}
pub fn spec_steps_any() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["promise_any_via"],
        throws: None,
        prose:
            "Resolve with the first fulfilled entry; reject with AggregateError if all rejected.",
    }]
}
pub fn spec_steps_race() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord {
        step_id: "1".into(),
        abstract_ops: vec!["promise_race_via"],
        throws: None,
        prose: "Settle with the first-settled entry of the iterable.",
    }]
}
