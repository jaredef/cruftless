...
pub fn spec_steps_keys() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord {
            step_id: "2".into(),
            abstract_ops: vec!["enumerable_own_keys"],
            throws: None,
            prose: "Return ? EnumerableOwnPropertyNames(obj, key).",
        },
    ]
}
...
pub fn spec_steps_values() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord {
            step_id: "2".into(),
            abstract_ops: vec!["enumerable_own_values"],
            throws: None,
            prose: "Return ? EnumerableOwnPropertyNames(obj, value).",
        },
    ]
}
...
pub fn spec_steps_entries() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord {
            step_id: "2".into(),
            abstract_ops: vec!["enumerable_own_entries"],
            throws: None,
            prose: "Return ? EnumerableOwnPropertyNames(obj, key+value).",
        },
    ]
}
...
pub fn spec_steps_get_own_property_names() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord {
            step_id: "2".into(),
            abstract_ops: vec!["own_property_names_via"],
            throws: None,
            prose: "Return CreateArrayFromList(? GetOwnPropertyKeys(obj, string)).",
        },
    ]
}
...
pub fn spec_steps_get_own_property_symbols() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord {
            step_id: "2".into(),
            abstract_ops: vec!["own_property_symbols_via"],
            throws: None,
            prose: "Return CreateArrayFromList(? GetOwnPropertyKeys(obj, symbol)).",
        },
    ]
}
