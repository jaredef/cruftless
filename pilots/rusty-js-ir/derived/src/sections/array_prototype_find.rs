...
fn preamble(method: &str) -> Vec<Step> {
    vec![
        Step {
            spec_step: "param.predicate".into(),
            node: IRNode::Let {
                name: "predicate".into(),
                value: Expr::Arg(0),
            },
...
pub fn build_find_last() -> IRFunction {
    let body = vec![Step {
        ...
        node: IRNode::Return(Expr::CallBuiltin {
            name: "array_proto_find_last_via",
...
pub fn build_find_last_index() -> IRFunction {
    let body = vec![Step {
        spec_step: "1".into(),
        node: IRNode::Return(Expr::CallBuiltin {
            name: "array_proto_find_last_index_via",
            args: vec![Expr::AllArgs],
        }),
    }];
    IRFunction {
...
pub fn spec_steps_find() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord {
            ...
            throws: None,
            prose: "If IsCallable(predicate) is false, throw TypeError.",
        },
        SpecStepRecord {
        ...
        SpecStepRecord {
            ...
            throws: None,
            prose: "Let testResult be ToBoolean(? Call(predicate, thisArg, « kValue, 𝔽(k), O »)).",
        },
        SpecStepRecord {
            step_id: "5.d".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "If testResult is true, return kValue.",
        },
        SpecStepRecord {
            step_id: "5.d.i".into(),
            abstract_ops: vec![],
