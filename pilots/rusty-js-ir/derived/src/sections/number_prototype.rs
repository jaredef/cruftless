...
pub fn build_value_of() -> IRFunction {
    ...
    IRFunction { spec_section: "21.1.3.7".into(),
        rust_name: "number_prototype_value_of".into(),
        title: "Number.prototype.valueOf ( )".into(), body }
}
...
pub fn build_to_exponential() -> IRFunction {
    ...
    IRFunction { spec_section: "21.1.3.2".into(),
        rust_name: "number_prototype_to_exponential".into(),
        title: "Number.prototype.toExponential ( fractionDigits )".into(), body }
}

pub fn build_to_precision() -> IRFunction {
    let body = vec![
        Step { spec_step: "param.precision".into(),
            node: IRNode::Let { name: "precision".into(), value: Expr::Arg(0) }},
        Step { spec_step: "1".into(),
            node: IRNode::Return(Expr::CallBuiltin {
    ...
    IRFunction { spec_section: "21.1.3.5".into(),
        rust_name: "number_prototype_to_precision".into(),
        title: "Number.prototype.toPrecision ( precision )".into(), body }
}

pub fn spec_steps_value_of() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["number_proto_value_of_via"], throws: None,
...
pub fn build_boolean_value_of() -> IRFunction {
    ...
    IRFunction { spec_section: "20.3.3.3".into(),
        rust_name: "boolean_prototype_value_of".into(),
        title: "Boolean.prototype.valueOf ( )".into(), body }
}
...
pub fn build_boolean_to_string() -> IRFunction {
    ...
    IRFunction { spec_section: "20.3.3.2".into(),
        rust_name: "boolean_prototype_to_string".into(),
        title: "Boolean.prototype.toString ( )".into(), body }
}

pub fn spec_steps_boolean_value_of() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["boolean_proto_value_of_via"], throws: None,
        prose: "Return ? ThisBooleanValue(this)." }]
}
pub fn spec_steps_boolean_to_string() -> Vec<SpecStepRecord> {
    vec![SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["boolean_proto_to_string_via"], throws: None,
