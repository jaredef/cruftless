...
pub fn build_to_primitive() -> IRFunction {
    let body = vec![
        ...
        Step {
            ...
            node: IRNode::If {
                ...
                then_body: vec![
                    ...
                    // primitive return.
                    Step {
                        spec_step: "2.b.ii.check".into(),
                        node: IRNode::If {
                            cond: Expr::Not(b(Expr::IsSpecObject(b(v("result"))))),
                            then_body: vec![Step {
                                spec_step: "2.b.ii.return".into(),
                                node: IRNode::Return(v("result")),
                            }],
                            else_body: vec![],
                        },
                    },
        ...
        // If hint === "string", swap.
        Step {
            spec_step: "3.hint_check".into(),
            node: IRNode::If {
                cond: Expr::StrictEq(b(v("hint")), b(Expr::Str("string".into()))),
                then_body: vec![
                    Step {
                        spec_step: "3.swap.1".into(),
                        node: IRNode::Assign {
                            name: "method1".into(),
                            value: Expr::Str("toString".into()),
                        },
        ...
        Step {
            spec_step: "4.m1.callable".into(),
            node: IRNode::If {
                cond: Expr::IsCallable(b(v("m1"))),
                then_body: vec![
                    Step {
                        spec_step: "4.m1.call".into(),
                        node: IRNode::Let {
                            name: "r1".into(),
                            value: Expr::Call {
                                function: b(v("m1")),
                    ...
                    Step {
                        spec_step: "4.m1.check".into(),
                        node: IRNode::If {
                            cond: Expr::Not(b(Expr::IsSpecObject(b(v("r1"))))),
                            then_body: vec![Step {
                                spec_step: "4.m1.return".into(),
                                node: IRNode::Return(v("r1")),
                            }],
                            else_body: vec![],
                        },
                    },
        ...
        Step {
            spec_step: "5.m2.callable".into(),
            node: IRNode::If {
                cond: Expr::IsCallable(b(v("m2"))),
                then_body: vec![
                    Step {
                        spec_step: "5.m2.call".into(),
                        node: IRNode::Let {
                            name: "r2".into(),
                            value: Expr::Call {
                                function: b(v("m2")),
                    ...
                    Step {
                        spec_step: "5.m2.check".into(),
                        node: IRNode::If {
                            cond: Expr::Not(b(Expr::IsSpecObject(b(v("r2"))))),
                            then_body: vec![Step {
                                spec_step: "5.m2.return".into(),
                                node: IRNode::Return(v("r2")),
                            }],
                            else_body: vec![],
                        },
                    },
...
pub fn spec_steps_to_primitive() -> Vec<SpecStepRecord> {
    vec![
        SpecStepRecord {
            ...
            abstract_ops: vec![],
            throws: None,
            prose: "Non-Object: return as-is.",
        },
        SpecStepRecord {
            step_id: "1.return".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "Return primitive.",
        },
        SpecStepRecord {
            step_id: "2.a.lookup".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "exotic = Get(value, @@toPrimitive).",
        },
        SpecStepRecord {
            step_id: "2.b.has_exotic".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "If exotic is callable.",
        },
        SpecStepRecord {
            step_id: "2.b.i.call".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "result = Call(exotic, value, [hint]).",
        },
        SpecStepRecord {
            step_id: "2.b.ii.check".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "If result is not Object.",
        },
        SpecStepRecord {
            step_id: "2.b.ii.return".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "Return result.",
        },
        SpecStepRecord {
            step_id: "2.b.iii.throw".into(),
            abstract_ops: vec![],
            throws: Some("TypeError"),
            prose: "@@toPrimitive returned Object.",
        },
        SpecStepRecord {
            step_id: "3.order".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "Initialize method order.",
        },
        SpecStepRecord {
            step_id: "3.order.alt".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "Second method initial.",
        },
        SpecStepRecord {
            step_id: "3.hint_check".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "If hint is 'string', swap.",
        },
        SpecStepRecord {
            step_id: "3.swap.1".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "method1 = toString.",
        },
        SpecStepRecord {
            step_id: "3.swap.2".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "method2 = valueOf.",
        },
        SpecStepRecord {
            step_id: "4.m1.lookup".into(),
            abstract_ops: vec!["get_via"],
            throws: None,
            prose: "m1 = Get(value, method1).",
        },
        SpecStepRecord {
            step_id: "4.m1.callable".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "If m1 is callable.",
        },
        SpecStepRecord {
            step_id: "4.m1.call".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "r1 = Call(m1, value).",
        },
        SpecStepRecord {
            step_id: "4.m1.check".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "If r1 is not Object.",
        },
        SpecStepRecord {
            step_id: "4.m1.return".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "Return r1.",
        },
        SpecStepRecord {
            step_id: "5.m2.lookup".into(),
            abstract_ops: vec!["get_via"],
            throws: None,
            prose: "m2 = Get(value, method2).",
        },
        SpecStepRecord {
            step_id: "5.m2.callable".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "If m2 is callable.",
        },
        SpecStepRecord {
            step_id: "5.m2.call".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "r2 = Call(m2, value).",
        },
        SpecStepRecord {
            step_id: "5.m2.check".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "If r2 is not Object.",
        },
        SpecStepRecord {
            step_id: "5.m2.return".into(),
            abstract_ops: vec![],
            throws: None,
            prose: "Return r2.",
        },
        SpecStepRecord {
            step_id: "6.throw".into(),
            abstract_ops: vec![],
            throws: Some("TypeError"),
            prose: "All methods returned Object.",
        },
    ]
}
