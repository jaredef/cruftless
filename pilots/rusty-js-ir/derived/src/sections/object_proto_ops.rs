...
pub fn spec_steps_get_prototype_of() -> Vec<SpecStepRecord> {
    vec![
        ...
        SpecStepRecord { step_id: "2".into(), abstract_ops: vec!["get_prototype_of_via"], throws: None, prose: "Return ? obj.[[GetPrototypeOf]]()." },
    ]
}

pub fn spec_steps_set_prototype_of() -> Vec<SpecStepRecord> {
    vec![
        SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["ToObject"], throws: None, prose: "Let O be ? RequireObjectCoercible(O)." },
        SpecStepRecord { step_id: "2".into(), abstract_ops: vec!["set_prototype_of_via"], throws: None, prose: "Perform ? O.[[SetPrototypeOf]](proto). Return O." },
    ]
}

pub fn spec_steps_is_extensible() -> Vec<SpecStepRecord> {
    vec![
        SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["is_extensible_via"], throws: None, prose: "If Type(O) is not Object, return false. Return ? IsExtensible(O)." },
    ]
}

pub fn spec_steps_is_frozen() -> Vec<SpecStepRecord> {
    vec![
        SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["is_frozen_via"], throws: None, prose: "If Type(O) is not Object, return true. Return ? TestIntegrityLevel(O, frozen)." },
    ]
}

pub fn spec_steps_is_sealed() -> Vec<SpecStepRecord> {
    vec![
        SpecStepRecord { step_id: "1".into(), abstract_ops: vec!["is_sealed_via"], throws: None, prose: "If Type(O) is not Object, return true. Return ? TestIntegrityLevel(O, sealed)." },
    ]
}
