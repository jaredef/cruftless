# ast-bytecode-wrong-result — Trajectory

## ABWR-EXT 0 — founding + exemplar suite + baseline-TBD (2026-05-25)

**Trigger**: Top-10 spawn batch per keeper directive after canonical
full-suite Pin-Art zoom-out. This is rank #3 of the matrix
(1244 fails) and is the highest-yield parity lane shape per heuristics §IV.B.
...
**Status**: ABWR-EXT 0 founding closed. Apparatus operational; first
