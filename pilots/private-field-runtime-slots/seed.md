...
- Optional-chain private-field runtime semantics remain open.
...
PFRS-EXT 1 landed locally. Runtime compiles; release binary keeps direct PNL at `40/40` and moves the focused PNL list from `140/194` to `160/194`.
