...
**Status**: TECR-EXT 2 CLOSED. Matrix re-rendered at `pilots/pilots/test262-categorize/full-suite/results/2026-05-25-full/`. The runtime-tier coordinate is small (10 records: Temporal/Intl) but coherent — cluster-coherence-multiplier shape per Finding TECR.1.
