...
fn main() {
    ...
    for _ in 0..2000 {
        ...
        if canonical.to_be_bytes(32) != v2.to_be_bytes(32) { div_v2 += 1; }
        if canonical.to_be_bytes(32) != v3.to_be_bytes(32) { div_v3 += 1; }
    }
    println!("fuzz: v2 diverged {}/2000; v3 diverged {}/2000", div_v2, div_v3);
}
