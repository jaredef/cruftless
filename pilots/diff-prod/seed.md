...
**Status as of 2026-05-22**: **TELOS A HIT + TELOS B (17/17)**. Seventeen F-category fixtures, all PASS. Twenty substrate fixes landed via diff-prod since founding. Coverage now spans JSON, Buffer, strings, Map/Set, async/Promise, error-throws, RegExp (incl. lastIndex + $-substitution), generators, Proxy, structuredClone.
