...
**Status as of 2026-05-22**: **TELOS A HIT + TELOS B (21/21)**. Twenty-one F-category fixtures, all PASS. Twenty-one substrate fixes landed via diff-prod since founding. Coverage now spans JSON, Buffer, strings, Map/Set, async/Promise, error-throws, RegExp (incl. lastIndex + $-substitution), generators, Proxy, structuredClone.
