---
**DEPRECATED 2026-05-28** per keeper directive Telegram 10200.
**Successor**: `apparatus/docs/repository-apparatus.md` (reformulated to integrate the triumvirate governance frame).
**Reason for deprecation**: the prior articulation was anchored on the keeper-plus-single-resolver dyad. The engagement has exceeded the dyad's capacity (see Telegram 10185–10187 merge incident); the triumvirate ontology + audit + operational protocol that landed in the same epoch required the apparatus's self-description to be re-anchored on the new governance frame. This doc is preserved for trajectory binding only; do not consult as current discipline.
---
