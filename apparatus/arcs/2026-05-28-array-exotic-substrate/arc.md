...
| `typed-array-byte-storage-conformance` | Vec<Value> → Vec<u8> + NumberToRawBytes / RawBytesToNumeric per ECMA-262 §6.1.6.1 (architectural precursor; cascades TAECSF sub-substrates per Doc 739) | FOUNDED 2026-05-30 (TABSC-EXT 0; precursor architectural rung per pipeline-alphabet-audit + four-corpus-doc reading per keeper-APPROVED proposal Telegram 10596) | +4 TAWR / +1 TAMM at founding rung; cascade probe 10/10 PASS; TABSC-EXT 1 DataView coercion-faithfulness landed (probe 7/7 PASS) |
| `array-strict-throw-discipline` | Array.prototype mutating methods (pop/push/shift/unshift/splice/sort) throw TypeError on frozen / non-writable-length receivers per §10.4.2.1 + §23.1.3 | FOUNDED 2026-05-30 (ASTA-EXT 0; first substrate-spawn from SAMPLE.1 Doc 721 chain-bundle decomposition per keeper-APPROVED proposal Telegram 10614) | probe 7/7 PASS; cluster gates preserved; +1 diff-prod; test262-sample +0.1 PP at ±1 PASS variance (Rule 29 falsifier observed; DET.4 candidate) |
