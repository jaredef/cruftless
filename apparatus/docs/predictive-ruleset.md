...
**Status as of 2026-05-30**: **29 rules total; rules 1-15 + 17-29 articulated in this doc** (rule 16 does not exist in the canonical source per Doc 727 §X append-only preservation). Rules 17-22 (Addenda XII + XIII) consolidated 2026-05-30 per helmsman session under keeper directive Telegram 10574 closing the carry-forward gap surfaced by audit-ledger Entries 001 / 002 / 003 / 004. Rules 23-26 promoted 2026-05-25 / 2026-05-28 from findings NLC.1 / IR.29 / IR.32 / IR.27. **Rules 27-28 promoted 2026-05-30 from findings TAECSF.3 + APP.PIPELINE-1 at findings-disposition cycle 2** (audit-ledger Entry 007; per keeper directive Telegram 10600). **Rule 29 promoted 2026-05-30 amending Rule 2** via back-reference per Doc 727 §X append-only discipline (audit-ledger Entry 009 candidate surfaced post-test262-sample-determinism observation; per keeper directive Telegram 10610). Companion apparatus-tier prospective doc: `apparatus/docs/measurement-determinism-2026-05-30.md`.
