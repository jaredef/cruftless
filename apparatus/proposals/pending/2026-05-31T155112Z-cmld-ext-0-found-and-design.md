...
Commit `af00e148` founds the nested `cjs-esm-namespace-pipeline/cjs-module-lexer-derived` (CMLD) locale and lands a design-only scanner architecture. No runtime source changed.
