...
covers_commits:
  - af00e14878d79235cde3a2517664d387a71e3a03
---
...
- **Design-only, no runtime risk.** Commit `af00e148` touches only the new nested locale `pilots/cjs-esm-namespace-pipeline/cjs-module-lexer-derived/` (seed/design/trajectory) and `apparatus/locales/manifest.json` (refresh). Gates legitimately not rerun.
